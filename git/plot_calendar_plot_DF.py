...
#weather regime setup

#regime labeling

#regime_number = [0,1,2,3,4,5,6,7]
...
main_dir = '../..' #'/home/fabian/Documents/UniKIT/Travel_Grant/Research/Reading_attempt/dunkelflauten_analysis/'
...
iwr_name = iwr
#iwr_name = pd.Series([regime_name[x] for x in iwr.values], index=iwr.index)
#extend iwr to hourly data by taking the wr from before, other option would be reduce the load from hourly data to 3hourly data
...
# in total there is a slight offset inside due to leap years and then changing doy to doy_winter, but this is not significant
