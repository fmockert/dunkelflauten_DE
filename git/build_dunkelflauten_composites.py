...
date_file = open("%s/wr/%s_dates_wr_DE_0.06_48.txt"%(dir_out_variables, wr), "r")
...
abs_composite.to_netcdf("%s/%s_%sabs"%(dir_composites, wr, variable))
...
ano_composite.to_netcdf("%s/%s_%sano_%s_clim"%(dir_composites, wr, variable, clim_type))
