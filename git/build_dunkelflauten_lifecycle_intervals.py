...
# Weather regime labeling
#regime_numbers =[0,1,2,3,4,5,6,7]
#regime_names = ["No", "AT", "GL", "AR", "ScTr", "EuBL", "ScBL", "ZO"]
#regime_alternative_names = ["No", "AT", "GL", "AR", "ZOEA", "ZOWE", "BL", "ZO"]
#regime_numbers_sorted = [1,7,4,3,5,6,2,0]
