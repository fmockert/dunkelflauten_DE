"""
Plot the bootstrapping of weather regime life cycle durations including Dunkelflauten (Dunkelflauten sample) 
and weather regimes life cycle durations not necessarily including Dunkelflauten (reference sample) 
"""
