"""Build the bootstrapping of weather regimes including Dunklelflauten 
and not necessarily including Dunkelflauten
"""
...
def random_pick(input_data, select_variable, double):
    """
    create function with input data and select_variable, 
    double=True allows LC to appear multiple times
    """
