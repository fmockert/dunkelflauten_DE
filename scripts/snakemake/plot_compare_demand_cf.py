"""
Plot the comparison between average capacity factor anomalies 
during Dunkelflauten and average demand anomalies during Dunkelflauten.
"""
...
if __name__ == "__main__":
  ...
  scattered_regimes = ['EuBL', 'ScBL', 'GL']
  ...
  # Save the figure
  name_split = snakemake.output.plot_demand.split('/')
  n=name_split[0]
